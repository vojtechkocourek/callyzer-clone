...
export default function Header({ title, subtitle }: { title: string; subtitle?: string }) {
  return (
    <header className="bg-white border-b border-slate-200 px-4 sm:px-6 py-3 sm:py-4 flex items-center gap-3">
      ...
      <div className="hidden lg:flex items-center gap-2 text-sm bg-slate-100 rounded-lg px-3 py-1.5 text-slate-500 w-72">
        <Search size={14} />
        <input
